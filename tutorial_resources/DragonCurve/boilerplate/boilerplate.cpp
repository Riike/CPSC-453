...
int main(int argc, char *argv[])
{
	...
	if(!LoadGeometry(&geometry, points.data(), colors.data(), points.size()))
	...
	{
		if(lastIterationNum != dragonCurveIterations){
			generateDragonCurve(
				Line(vec2(-0.5f, 0), vec2(0.5f, 0)),
				dragonCurveIterations,
				&points,
			...
			lastIterationNum = dragonCurveIterations;
		}
